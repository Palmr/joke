...
public class KdbClient implements AutoCloseable {
  ...
  public Object send(final String expr) throws KdbException, IOException {
    assert KdbClientThreadAssertion.isSameThread(this)
        : KdbClientThreadAssertion.buildMessage(this);
  ...
  private Object sendSync(Object x) throws KdbException, IOException {
    ...
    assert kdbMessageHeader.getMessageType() == MessageType.response
        : "Expected response type message when sync message sent";
  ...
  private void handshake(
      final String username, final String password, final KdbProtocol kdbProtocol)
      throws IOException, KdbException {
